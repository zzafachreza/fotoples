...
FROM
    ...
    INNER JOIN `kategori_cetak` 
        ON (`media_cetak`.`id_kategori` = `kategori_cetak`.`id_kategori`) WHERE status_transaksi='MENUNGGU' GROUP BY transaksi_bayar.inv; ");
 ...
 -->
                        ...
                        <!--       <td><?php echo $tampil['telpon_pelanggan'] ?></td>
                              ...
                              <td><?php echo number_format($tampil['bayar']) ?>
                                ...
                                <form id="formbaru<?php echo $tampil['inv'] ?>" onsubmit="editBayar('<?php echo $tampil['inv'] ?>');return false" style="display: none">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                          <label>Bayar</label>
                                           <input id="bayarbaru<?php echo $tampil['inv'] ?>" type="number" name="bayar" class="form-control" autocomplete="off" autofocus="autofocus" style="width: 400px">              
                                        </div>
                              ...
                              <td> 
                                ...
                                <button data-pelanggan="<?php echo $tampil['id_pelanggan'] ?>" data-id="<?php echo $tampil['inv'] ?>" class="editbaru btn btn-primary" data-toggle="tooltip" data-placement="top" title="edit" ><i class="fa fa-pencil-alt"></i></button>
                        ...
                        <script type="text/javascript">
                                    ...
                                    function editBayar(x){
                                       ...
                                       $.ajax({
                                        ...
                                        success:function(data){
                                           ...
                                           $.ajax({
                                            ...
                                            success:function(data){
                                             location.href='home.php?open=baru'
                                            }
                                          })
                                      ...
                                      $(".editbaru").click(function(e){

                                        e.preventDefault();
                                        var inv = $(this).attr("data-id");
                                        $("#formbaru"+inv).slideToggle();
                                        $("#bayarbaru"+inv).focus();
